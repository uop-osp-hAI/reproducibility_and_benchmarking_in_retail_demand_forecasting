...
* **Prerequisites:** Checkpoint files generated by the cFavorita pipeline. Check this link to download the checkpoint files and save them locally (generated from seq2seq reproduction run).
* File name: case_study_2_cfavorita_checkpoints (download and extract the zipped files and save them to your work environment)
* Link to download from: https://zenodo.org/uploads/21611057
These are required for the successful execution of the statistical and ML benchmarks notebook.
